...
{isupdate ?
  <div>
    <h5 style={{ marginTop: "20px" }}>Add your Important Notes</h5>
    <input type="text" value={text1} onChange={(e) => { setText1(e.target.value) }} style={{ width: "300px", marginTop: "10px" }} placeholder="Enter your Notes Here" />
  ...
  <div>
    <button style={{ border: "0px", borderRadius: "4px", padding: "-30px", background: "none" }} onClick={onClickAddTaskHandler}>
      <div style={{ width: "650px", height: "50px", background: "#D0D3D4 ", borderRadius: "4px", padding: "10px" }}>
        ...
        <h5 style={{ textAlign: "left" }}><BsPlusLg style={{ marginRight: "20px" }} />Add Important Notes</h5>
...
}
{
  allEntry.map((item, index) => {
    return (
      ...
      <h4 style={{ color: "#566573" }}>Today Note {index + 1}</h4>
